        ...
        <div className="flex justify-end">
          {
            ...
            <Button className="w-fit bg-[#0095F6]"> <Loader2 className="mr-2 h-4 w-4 animate-spin"/>Please wait...</Button>
          
          ) : ( <Button onClick={editProfileHandler} className="w-fit bg-[#0095F6]">Submit</Button>)
          }
